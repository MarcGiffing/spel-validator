 ...
 * <p>
 * This class collects all bean and method references to found during the parsing process.
 * <p>
...
public class ExpressionResult {
    ...
    /**
     * Set of method references to found in the SpEL expression. Each reference includes the method name and its parameters.
     */
    private Set<SpelMethod> methodReferences = new HashSet<>();

    /**
     * Adds a bean reference to found in the SpEL expression.
     *
    ...
    /**
     * Adds a method reference to found in the SpEL expression.
     *
